...
async def trigger_ipo_ingestion(
    provider_code: str = Query("UPSTOX_API", description="Provider code to sync (UPSTOX_API or MOCK_PROVIDER)"),
    ...
    from the specified provider into PostgreSQL.
    """
    if provider_code.upper() == "MOCK_PROVIDER":
